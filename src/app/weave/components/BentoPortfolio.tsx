  ...
  return (
    <section
      ...
      <div
        ...
        onClick={() => { setPlayingVideo(null); setIsMuted(false); }}>
          <div
          ...
          onClick={(e) => e.stopPropagation()}>
            ...
            className="absolute top-3 right-3 z-10 flex items-center justify-center rounded-full transition-all duration-200 active:scale-95"
            style={{
              width: '44px',
              height: '44px',
              background: isMuted ? 'rgba(220,38,38,0.85)' : 'rgba(22,163,74,0.85)',
              border: `2px solid ${isMuted ? 'rgba(248,113,113,0.8)' : 'rgba(74,222,128,0.8)'}`,
              backdropFilter: 'blur(8px)',
              boxShadow: isMuted ? '0 0 12px rgba(220,38,38,0.5)' : '0 0 12px rgba(22,163,74,0.5)'
            }}

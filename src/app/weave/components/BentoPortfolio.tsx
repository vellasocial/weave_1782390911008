      ...
      <div
        ...
        onClick={() => setPlayingVideo(null)}>
          ...
          onClick={(e) => e.stopPropagation()}>
            ...
            className="absolute bottom-4 right-4 z-20 flex items-center justify-center rounded-full transition-all duration-200 active:scale-95"
            style={{
              width: '52px',
              height: '52px',
              background: isMuted ? 'rgba(217,70,168,0.85)' : 'rgba(196,181,247,0.9)',
              border: `2px solid ${isMuted ? '#D946A8' : '#C4B5F7'}`,
              backdropFilter: 'blur(8px)',
              boxShadow: isMuted ? '0 0 16px rgba(217,70,168,0.5)' : '0 0 16px rgba(196,181,247,0.5)'
            }}
